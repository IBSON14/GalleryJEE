...
public class UtilisateurServlet extends HttpServlet {
	...
	private static final String SAVE_DIR = "/home/ibrahima/Bureau/eclipse-workspace/imagesuploaded/";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (requestedUrl.equals("/user/create")) {
			...
			if (session != null) {
				...
				request.setAttribute("albums", DaoAlbum.albumByUser(login));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (requestedUrl.equals("/user/connect")) {
			...
			request.setAttribute("albums", DaoAlbum.albumByUser(proprietaire));
			getServletContext().getRequestDispatcher(VUE_ALBUMS).forward(request, response);
		} else if (requestedUrl.equals("/user/album/voir")) {
			request.setCharacterEncoding("utf-8");
